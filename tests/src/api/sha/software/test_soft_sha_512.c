/**
 * @file test_soft_sha_512.c
 * @brief test suite for soft_sha.c on sha 512 algorithm
 *
...
TEST(soft_sha_512, msg_192B_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
...
TEST(soft_sha_512, msg_2_block_and_half_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
...
TEST(soft_sha_512, msg_and_hash_twice)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
...
TEST(soft_sha_512, msg_1_block_in_3_pieces_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
    ...
    result = soft_sha_core(
        NULL, &sha_ctx, &message[2 * (SHA512_BYTE_BLOCKSIZE / 3 - 1)],
