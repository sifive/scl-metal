...
TEST(soft_sha_224, msg_96B_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
    ...
    result =
        soft_sha_init(NULL, &sha_ctx, SCL_HASH_SHA224, SCL_BIG_ENDIAN_MODE);
    TEST_ASSERT_TRUE(0 == result);
...
TEST(soft_sha_224, msg_2_block_and_half_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
...
TEST(soft_sha_224, msg_and_hash_twice)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
    ...
    result = soft_sha_init(NULL, &sha_ctx, SCL_HASH_SHA224, SCL_BIG_ENDIAN_MODE);
    TEST_ASSERT_TRUE(0 == result);
...
TEST(soft_sha_224, msg_1_block_in_3_pieces_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
    ...
    result = soft_sha_core(
        NULL, &sha_ctx, &message[2 * (SHA256_BYTE_BLOCKSIZE / 3 - 1)],
