/**
 * @file test_soft_sha_256.c
 * @brief test suite for soft_sha.c on sha 256 algorithm
 *
...
TEST(soft_sha_256, msg_96B_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
...
TEST(soft_sha_256, msg_2_block_and_half_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
...
TEST(soft_sha_256, msg_and_hash_twice)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
