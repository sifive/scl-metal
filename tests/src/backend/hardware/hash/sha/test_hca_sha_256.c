...
TEST(hca_sha_256, msg_96B_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
    ...
    static const uint8_t expected_digest[SHA256_BYTE_HASHSIZE] = {
        0x9A, 0x36, 0xF0, 0xD8, 0xBE, 0x45, 0x21, 0xC3, 0x8F, 0x13, 0x63,
        0xD5, 0x62, 0x55, 0x8F, 0x75, 0x90, 0xB4, 0x0E, 0x04, 0x6D, 0xC2,
        0x9A, 0x66, 0xCC, 0x4B, 0x8E, 0x0A, 0xD3, 0xBC, 0xE8, 0x84};

    result = hca_sha_init(&scl, &sha_ctx, SCL_HASH_SHA256, SCL_BIG_ENDIAN_MODE);
    TEST_ASSERT_TRUE(0 == result);
...
TEST(hca_sha_256, msg_2_block_and_half_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
    ...
    static const uint8_t expected_digest[SHA256_BYTE_HASHSIZE] = {
        0xAA, 0x0C, 0x19, 0xBC, 0x03, 0x5F, 0x85, 0x51, 0x02, 0x32, 0x67,
        0x18, 0xCF, 0x53, 0x09, 0x3E, 0x06, 0x83, 0x8A, 0x0A, 0xC3, 0x41,
        0x04, 0x38, 0x72, 0x44, 0x5D, 0x0E, 0xCA, 0x61, 0xF2, 0xB7};
...
TEST(hca_sha_256, msg_and_hash_twice)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
    ...
    static const uint8_t expected_digest_2[SHA256_BYTE_HASHSIZE] = {
        0x23, 0x69, 0x79, 0xA4, 0x42, 0x7C, 0x30, 0x95, 0xCB, 0x3F, 0xCE,
...
TEST(hca_sha_256, msg_1_block_in_3_pieces_digest_aligned)
{
    int32_t result = 0;
    sha_ctx_t sha_ctx;
    ...
    static const uint8_t expected_digest[SHA256_BYTE_HASHSIZE] = {
        0x8D, 0xC8, 0x4E, 0x43, 0x57, 0xA2, 0xB2, 0xBE, 0xF4, 0xF6, 0x8F,
