/**
 * @file test_scl_hmac.c
 * @brief test suite for scl_hmac.c
 *
...
TEST_TEAR_DOWN(scl_hmac) {}

/* HMAC sha 224 */
TEST(scl_hmac, sha224_keysize_shorter_than_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    ...
    result = scl_hmac_init(&scl, &hmac_ctx, &sha_ctx, SCL_HASH_SHA224, key,
                           sizeof(key));
    TEST_ASSERT_TRUE(0 == result);

    result = scl_hmac_core(&scl, &hmac_ctx, message, sizeof(message));
    TEST_ASSERT_TRUE(0 == result);

    result = scl_hmac_finish(&scl, &hmac_ctx, mac, &mac_len);
    TEST_ASSERT_TRUE(0 == result);
    TEST_ASSERT_TRUE(SHA224_BYTE_HASHSIZE == mac_len);
    TEST_ASSERT_EQUAL_HEX8_ARRAY(expected_mac, mac, sizeof(expected_mac));
}

TEST(scl_hmac, sha224_keysize_equal_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
...
TEST(scl_hmac, sha224_keysize_greater_than_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
...
/* HMAC sha 256 */
TEST(scl_hmac, sha256_keysize_shorter_than_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
    ...
    result = scl_hmac_init(&scl, &hmac_ctx, &sha_ctx, SCL_HASH_SHA256, key,
                           sizeof(key));
    TEST_ASSERT_TRUE(0 == result);
...
TEST(scl_hmac, sha256_keysize_equal_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
...
TEST(scl_hmac, sha256_keysize_greater_than_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
...
/* HMAC sha 384 */
TEST(scl_hmac, sha384_keysize_shorter_than_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
    ...
    result = scl_hmac_init(&scl, &hmac_ctx, &sha_ctx, SCL_HASH_SHA384, key,
                           sizeof(key));
    TEST_ASSERT_TRUE(0 == result);
...
TEST(scl_hmac, sha384_keysize_equal_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
...
TEST(scl_hmac, sha384_keysize_greater_than_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
...
/* HMAC sha 512 */
TEST(scl_hmac, sha512_keysize_shorter_than_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
    ...
    result = scl_hmac_init(&scl, &hmac_ctx, &sha_ctx, SCL_HASH_SHA512, key,
                           sizeof(key));
    TEST_ASSERT_TRUE(0 == result);
...
TEST(scl_hmac, sha512_keysize_equal_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
...
TEST(scl_hmac, sha512_keysize_greater_than_blocksize)
{
    int32_t result;
    scl_hmac_ctx_t hmac_ctx;
    scl_sha_ctx_t sha_ctx;
